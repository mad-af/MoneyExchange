        ...
        <div class="row">
          ...
          <div class="col-lg-7">
            <div class="p-5">
              ...
              <form class="user" action="php/daftar.php" method="post">

                  <div class="form-group">
                    <input type="text" name="name" class="form-control form-control-user" id="exampleFirstName" placeholder="First Name" required>
                  </div>
